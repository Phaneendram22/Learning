...
#======================================================================
#
#  Version: 6.0 : Prepare_VM_IT_Tools.ATMU_UBT.v6.sh
#
#======================================================================
#
...
#======================================================================
#  Signature:
#       Prepare_VM_IT_Tools.ATMU_UBT.v6.sh
#
#======================================================================
#
...
#  Description:
#  :
#               Prepare_VM_IT_Tools.ATMU_UBT.v6.sh scripts does the following features.
#
#______________________________________________________________________
...
#       cd /tmp; wget  http://mirrors.it.att.com/pub/custom/SD/nasCommon/ubuntu/install_sudo.sh
        ...
        cd /tmp &&  wget --no-proxy wget http://mirrors.it.att.com/pub/custom/SD/nasCommon/ubuntu/install_sudo.sh
...
function Installing_UAM ()
{
        ...
        tar xvf /tmp/uam_extranet.tar -C /
        #
